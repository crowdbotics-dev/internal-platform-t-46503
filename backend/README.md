...
## Project Structure
    ...
    ├── internal_platform_t_46503  # Django project configurations
...
1. Clone this repo and `cd internal_platform_t_46503`
...
2. Clone this repo and `cd internal_platform_t_46503`
